              ...
              (table.getIsSomeRowsSelected() ||
                ...
                >
                  ...
                  >
                    ...
                    <Stack flex={1}>
                      {selectedViewsContent &&
                        selectedViewsContent(rowSelectionData)}
                    </Stack>
                  </Stack>
                </Stack>
              )}
                          ...
                          >
                            ...
                            'string' ? (
                              <Typography
                                variant="body2"
                                fontWeight={
                                  header.column.getIsSorted() && 'bold'
                                }
                              >
      ...
      {!disabledFooter && (
        <Box sx={{ position: 'relative' }}>
          <TablePagination
            ...
            rowsPerPage={
              table.getState().pagination.pageSize || pageSizeList[0]
            }
